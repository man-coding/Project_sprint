...
public class SecurityConfig {
  ...
  private final CustomOAuthenticationSuccessHandler customOAuthenticationSuccessHandler;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
      .oauth2Login()
      .successHandler(customOAuthenticationSuccessHandler); // 핸들러 등록
    ...
    http
      ...
      .permitAll() // 접근 권한
      .and()
      .csrf()  //csrf는 get을 제외하여 상태값을 위조(변경)할 수있는 post,put,delete 메소드를 막음
      .disable();
